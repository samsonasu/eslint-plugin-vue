    ...
    <template
      ...
      <div class="content beta-doc-description">
        <div class="warning custom-block">
          ...
          <p>This is documentation for version <code>{{docVersion}}</code>.<template v-if="hasNotYetBeenReleased"> Also, this documentation may contain content that has not yet been released.</template><br>
          If you want to check version <code>6.2.2</code> <a :href="v6DocLink">go here</a>.
          If you want to check previous releases <a href="https://github.com/vuejs/eslint-plugin-vue/releases">go here</a>.</p>
        </div>
      </div>
      <slot
        name="page-top"
